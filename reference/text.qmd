...
`publish` will dictate it **exactly as it stands**: your edits are never
re-cleaned.
...
| `--keep-front-matter` | | dictate the title page, authors and affiliations |
...
See also: [Use the CLI](../local/use.qmd).
